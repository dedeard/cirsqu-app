  ...
  return (
    <li className="relative" role="listitem">
      ...
      <Card
        ...
        isPressable
        shadow="none"
        className="border border-divider bg-opacity-75 dark:border-transparent"
      >
...
export const LessonListSkeleton: React.FC = () => {
  return (
    <li className="relative" role="listitem">
      ...
      <Card shadow="none" className="border border-divider bg-opacity-75 dark:border-transparent">
        <CardBody className="flex flex-col gap-2 p-4">
          <div className="flex gap-3">

...
const QuestionItem: React.FC<PropTypes> = () => {
  return (
    <a href="#" className="hoverable-default group relative flex flex-col gap-5 overflow-hidden rounded-lg border p-3  lg:p-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <span className="flex flex-col">
          <span className="mb-1 block text-sm leading-none">Dede ariansya</span>
          <span className="mb-2 block text-xs leading-none opacity-70">@dedeard</span>
          <span className="block text-xs leading-none opacity-70">Created at 3 days ago</span>
        </span>
      </div>
